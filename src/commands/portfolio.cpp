...
PortfolioCommand::PortfolioCommand(const std::string& name, const unsigned short numArguments, TgBot::Bot& bot, const std::int64_t chatId) :
Command(name, numArguments, bot, chatId){
}
